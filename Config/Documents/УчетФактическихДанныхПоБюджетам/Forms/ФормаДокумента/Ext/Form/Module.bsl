...
Процедура ПолучитьДанныеПоСтатье(Статья,СписокЦФО,ТабОперации,НомерРасчета)
	...
	////Если СохраненныеНастройкиКомпоновщика = Неопределено Тогда
		КомпоновщикНастроек.ЗагрузитьНастройки(СхемаКомпоновкиДанных.НастройкиПоУмолчанию);
	////Иначе
	////	//КомпоновщикНастроек.Инициализировать(Новый ИсточникДоступныхНастроекКомпоновкиДанных(СхемаКомпоновкиДанных));
	////	КомпоновщикНастроек.ЗагрузитьНастройки(СохраненныеНастройкиКомпоновщика);
