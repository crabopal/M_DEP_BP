...
Процедура УстановитьСтатусКонтрагентаИСМП()
	...
	// при отсутствии записей в регистре контрагент считается участником
	Если НаборЗаписей.Количество() = 0 
		И НЕ ПередачаДляСобственныхНуждИСМП Тогда
	...
	НоваяЗапись.СтатусУчастника = ?(ПередачаДляСобственныхНуждИСМП, 2, 1);
