...
Функция ДанныеРегистрационнойИнформации(ПараметрыРегистрации, ДанныеОператора, Ошибки)
	...
	Если Не ПараметрыРегистрации.НеИспользоватьПриглашения = Неопределено 
		И СервисЭДОКлиентСервер.СравнитьВерсииФорматовРегистрации(АктуальныйФормат.Версия, "5.04") >= 0 Тогда
	...
	Если ЗначениеЗаполнено(ПараметрыРегистрации.Комментарий) 
		И СервисЭДОКлиентСервер.СравнитьВерсииФорматовРегистрации(АктуальныйФормат.Версия, "5.04") >= 0 Тогда
