...
Функция ЕстьЭЗЗ(Объект)
	...
	СписокЗаявок = ОбменСГИСЭПДБПВызовСервера.ЭлектронныеДокументыПоОснованию(СписокОснований, Тип("ДокументСсылка.ЭлектронныйЗаказЗаявка"));
...
Асинх Процедура ВыбратьТипДокумента(Форма, ЭлементФормы)
	...
	ТипыДокументов.Добавить("ЭлектроннаяЗаказЗаявка", 			НСтр("ru = 'Электронная заказ (заявка)'"));
