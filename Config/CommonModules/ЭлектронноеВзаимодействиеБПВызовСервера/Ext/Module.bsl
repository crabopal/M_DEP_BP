...
Процедура ЗаполнитьШапкуВыписки(Организация, ДанныеВыписки, СтрокаТаблицыВыписок, МассивСчетов)
	...
	Для Каждого Выписка Из СтрокаТаблицыВыписок.Строки Цикл
		...
		СтрокаИтогов.ОборотВходящихПлатежей  = СтрокаИтогов.ОборотВходящихПлатежей  + ОборотВходящихПлатежей;
		СтрокаИтогов.ОборотИсходящихПлатежей = СтрокаИтогов.ОборотИсходящихПлатежей + ОборотИсходящихПлатежей;
	КонецЦикла;
