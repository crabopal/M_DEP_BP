...
Функция НовыеПараметрыПриглашения(ПараметрыСвязиИдентификаторов, ОтправительФизЛицо, ПолучательФизЛицо)
	...
	Если ТрансграничныйЭДО.ЭтоИностранныйОператор(ПараметрыПриглашения.ИдентификаторКонтрагента) Тогда
		ПараметрыПриглашения.АбонентНеТребуетПриглашений = 
	...
	Если СтрокаПараметровСвязи.ОбязательнаяОтправкаЗаявкиНаРоуминг Тогда
		ПараметрыПриглашения.АбонентНеТребуетПриглашений = Ложь;
		Если СтрокаПараметровСвязи.ПриглашениеОтправлено Тогда
	...
	Если ПараметрыПриглашения.АбонентНеТребуетПриглашений Тогда
		ПараметрыПриглашения.СтатусПриглашенияПредставление = Нстр("ru = 'Не требуется'");
	КонецЕсли;
