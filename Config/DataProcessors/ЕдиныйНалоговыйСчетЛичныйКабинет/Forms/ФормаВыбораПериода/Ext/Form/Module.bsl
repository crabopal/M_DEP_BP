...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.Кратность) Тогда
		Если Параметры.Кратность <> Перечисления.Периодичность.День
			Или Метаданные.ОбщиеФормы.Найти("ВыборСтандартногоПериодаДень") = Неопределено Тогда
	...
	Если НачалоДня(НачалоПериода) = НачалоДня(КонецПериода) И Элементы.ВыбратьДень.Видимость Тогда
...
Процедура ВыбратьДень(Команда)
	...
	ИмяФормыВыбораДня = "ОбщаяФорма.ВыборСтандартногоПериодаДень";
