...
Процедура ЗаполнитьПоШаблонуНаСервере(Знач ПараметрыШаблона)
	...
	Если ШаблонОчищаетПоля = Неопределено Или Не ШаблонОчищаетПоля Тогда
		ОчиститьНезаполненныеПоляШаблона(ПараметрыЗаказа);
	КонецЕсли;
...
&НаСервере
Процедура ОчиститьНезаполненныеПоляШаблона(ПараметрыЗаказа)
	...
	Для Каждого Реквизит Из ПараметрыЗаказа Цикл
		...
		ИначеЕсли ТипЗнч(Реквизит.Значение) = ТИП("Структура") Тогда
			ОчиститьНезаполненнуюСтруктуруШаблона(Реквизит, УдаляемыеКлючи);
		КонецЕсли;
	КонецЦикла;
...
&НаСервере
Процедура ОчиститьНезаполненнуюСтруктуруШаблона(Реквизит, УдаляемыеКлючи)
...
Процедура УстановитьУсловноеОформление()
	...
	Для Каждого ЭлементРазмещениеГруза Из Элементы.РазмещениеГруза.ПодчиненныеЭлементы Цикл
		...
		Если Не ЭлементРазмещениеГруза = Элементы.РазмещениеГрузаНаименование
			...
			И Не ЭлементРазмещениеГруза = Элементы.РазмещениеГрузаСтоимость Тогда
