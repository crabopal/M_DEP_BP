...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	//ГруппаОсновноеСредство.Расположение = РасположениеПоляКомпоновкиДанных.Вместе; processor
	ГруппаОсновноеСредство.Расположение = РасположениеПоляКомпоновкиДанных.ОтдельнаяКолонка;

	ТиповыеОтчеты.ДобавитьВыбранноеПоле(ГруппаОсновноеСредство, "ОсновноеСредство");
	//ТиповыеОтчеты.ДобавитьВыбранноеПоле(ГруппаОсновноеСредство, "ИнвентарныйНомер"); processor
