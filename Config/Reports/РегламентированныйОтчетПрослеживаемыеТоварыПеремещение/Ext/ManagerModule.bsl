...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение № 1 к письму ФНС России от 27.07.2022 № СД-4-15/9706@.";
	НоваяФорма.РедакцияФормы      = "от 27.07.2022 № СД-4-15/9706@.";
	НоваяФорма.ДатаНачалоДействия = '20221128';
...
Функция ДеревоФормИФорматов() Экспорт
	...
	ФормаОтчета2022Кв4 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
	"1184054", '2022-07-27', "СД-4-15/9706@", "ФормаОтчета2022Кв4");
	ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2022Кв4, "5.01");
